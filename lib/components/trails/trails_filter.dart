...
//   const TrailsFilter({Key? key}) : super(key: key);

//   @override
//   _TrailsFilterState createState() => _TrailsFilterState();
// }

// class _TrailsFilterState extends State<TrailsFilter> {
...
//   void initState() {
//     super.initState();
//     var rp = context.read<TrailsProvider>();
...
//                         child: Text('APPLY'),
//                         onPressed: () {
//                           context.read<TrailsProvider>().applyFilters(
...
//                         child: Text('CLEAR'),
//                         onPressed: () {
//                           context.read<TrailsProvider>().clearFilters();
//                           Navigator.of(context).pop();
//                         })),
//               ],
//             ),
