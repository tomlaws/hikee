...
class _TextInputState extends State<TextInput>
  ...
  Widget build(BuildContext context) {
    var w = Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Expanded(
        ...
        child: Container(
          ...
          child: TextField(
              focusNode: _focus,
              controller: widget.controller ?? widget.textEditingController,
    ...
    if (widget.transparent) return w;
    return AnimatedBuilder(
        animation: _colorTween, builder: (context, child) => w);
  }
}
