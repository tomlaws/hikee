...
class EventPage extends GetView<EventController> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 16.0),
                        child: SizedBox(
                            height: 32, child: _participantList(true, context)),
                      )
                    ],
                  ),
                ),
              ...
              child: Padding(
                  ...
                  child: MutationBuilder(
                    mutation: () {
                      ...
                      if (joined) {
                        return controller.quitEvent();
                      }
                      return controller.joinEvent();
                    },
  ...
  Widget _participantList(bool summary, BuildContext context) {
    int? take;
    double spacing = 8;
